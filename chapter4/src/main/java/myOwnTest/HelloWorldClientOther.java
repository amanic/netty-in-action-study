...
public class HelloWorldClientOther {
    private  int port;
    private  String address;

    public HelloWorldClientOther(int port, String address) {
        this.port = port;
...
//                .handler(new ClientChannelInitializer());
    ...
    public static void main(String[] args) {
        HelloWorldClientOther client = new HelloWorldClientOther(7788,"127.0.0.1");
        client.start();
    }
